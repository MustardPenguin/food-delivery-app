...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Value(java.lang.String event_id, java.lang.String payload, java.lang.Long created_at) {
   ...
   */
  public static order_updated.order_command.order_updated_events.Value.Builder newBuilder() {
    return new order_updated.order_command.order_updated_events.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static order_updated.order_command.order_updated_events.Value.Builder newBuilder(order_updated.order_command.order_updated_events.Value.Builder other) {
    if (other == null) {
      return new order_updated.order_command.order_updated_events.Value.Builder();
    } else {
      return new order_updated.order_command.order_updated_events.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static order_updated.order_command.order_updated_events.Value.Builder newBuilder(order_updated.order_command.order_updated_events.Value other) {
    if (other == null) {
      return new order_updated.order_command.order_updated_events.Value.Builder();
    } else {
      return new order_updated.order_command.order_updated_events.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(order_updated.order_command.order_updated_events.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(order_updated.order_command.order_updated_events.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.event_id)) {
        this.event_id = data().deepCopy(fields()[0].schema(), other.event_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder setEventId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder clearEventId() {
      event_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_updated.order_command.order_updated_events.Value.Builder clearCreatedAt() {
