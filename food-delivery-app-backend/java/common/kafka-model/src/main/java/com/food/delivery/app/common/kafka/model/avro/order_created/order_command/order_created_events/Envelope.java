 ...
 */
package order_created.order_command.order_created_events;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -329020633390963699L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"order_created.order_command.order_created_events\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"event_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}}],\"connect.name\":\"order_created.order_command.order_created_events.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.postgresql\",\"fields\":[{\"name\":\"version\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"connector\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":\"long\"},{\"name\":\"snapshot\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"true,last,false,incremental\"},\"connect.default\":\"false\",\"connect.name\":\"io.debezium.data.Enum\"},\"null\"],\"default\":\"false\"},{\"name\":\"db\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sequence\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"ts_us\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_ns\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"schema\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"table\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"txId\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"lsn\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"xmin\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.postgresql.Source\"}},{\"name\":\"transaction\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"block\",\"namespace\":\"event\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"total_order\",\"type\":\"long\"},{\"name\":\"data_collection_order\",\"type\":\"long\"}],\"connect.version\":1,\"connect.name\":\"event.block\"}],\"default\":null},{\"name\":\"op\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_us\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_ns\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.version\":2,\"connect.name\":\"order_created.order_command.order_created_events.Envelope\"}");
  ...
  private order_created.order_command.order_created_events.Value before;
  private order_created.order_command.order_created_events.Value after;
   ...
   */
  public Envelope(order_created.order_command.order_created_events.Value before, order_created.order_command.order_created_events.Value after, io.debezium.connector.postgresql.Source source, event.block transaction, java.lang.String op, java.lang.Long ts_ms, java.lang.Long ts_us, java.lang.Long ts_ns) {
    this.before = before;
    this.after = after;
    this.source = source;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (order_created.order_command.order_created_events.Value)value$; break;
    case 1: after = (order_created.order_command.order_created_events.Value)value$; break;
    case 2: source = (io.debezium.connector.postgresql.Source)value$; break;
    case 3: transaction = (event.block)value$; break;
    case 4: op = value$ != null ? value$.toString() : null; break;
   ...
   */
  public order_created.order_command.order_created_events.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(order_created.order_command.order_created_events.Value value) {
    this.before = value;
  }
   ...
   */
  public order_created.order_command.order_created_events.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(order_created.order_command.order_created_events.Value value) {
    this.after = value;
  }
   ...
   */
  public static order_created.order_command.order_created_events.Envelope.Builder newBuilder() {
    return new order_created.order_command.order_created_events.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static order_created.order_command.order_created_events.Envelope.Builder newBuilder(order_created.order_command.order_created_events.Envelope.Builder other) {
    if (other == null) {
      return new order_created.order_command.order_created_events.Envelope.Builder();
    } else {
      return new order_created.order_command.order_created_events.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static order_created.order_command.order_created_events.Envelope.Builder newBuilder(order_created.order_command.order_created_events.Envelope other) {
    if (other == null) {
      return new order_created.order_command.order_created_events.Envelope.Builder();
    } else {
      return new order_created.order_command.order_created_events.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private order_created.order_command.order_created_events.Value before;
    private order_created.order_command.order_created_events.Value.Builder beforeBuilder;
    private order_created.order_command.order_created_events.Value after;
    private order_created.order_command.order_created_events.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(order_created.order_command.order_created_events.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = order_created.order_command.order_created_events.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = order_created.order_command.order_created_events.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(order_created.order_command.order_created_events.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setBefore(order_created.order_command.order_created_events.Value value) {
     ...
     * @return This builder.
     */
    public order_created.order_command.order_created_events.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(order_created.order_command.order_created_events.Value.newBuilder(before));
        } else {
          setBeforeBuilder(order_created.order_command.order_created_events.Value.newBuilder());
        }
      }
    ...
    public order_created.order_command.order_created_events.Envelope.Builder setBeforeBuilder(order_created.order_command.order_created_events.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setAfter(order_created.order_command.order_created_events.Value value) {
     ...
     * @return This builder.
     */
    public order_created.order_command.order_created_events.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(order_created.order_command.order_created_events.Value.newBuilder(after));
        } else {
          setAfterBuilder(order_created.order_command.order_created_events.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public order_created.order_command.order_created_events.Envelope.Builder setAfterBuilder(order_created.order_command.order_created_events.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public order_created.order_command.order_created_events.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setTransaction(event.block value) {
    ...
    public order_created.order_command.order_created_events.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setTsUs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearTsUs() {
      ts_us = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder setTsNs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Envelope.Builder clearTsNs() {
      ts_ns = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (order_created.order_command.order_created_events.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (order_created.order_command.order_created_events.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
        ...
        record.op = fieldSetFlags()[4] ? this.op : (java.lang.String) defaultValue(fields()[4]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new order_created.order_command.order_created_events.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new order_created.order_command.order_created_events.Value();
        }
