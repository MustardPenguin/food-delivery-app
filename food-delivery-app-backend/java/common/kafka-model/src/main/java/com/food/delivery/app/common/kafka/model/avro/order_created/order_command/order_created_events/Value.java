...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -315981114996313962L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"order_created.order_command.order_created_events\",\"fields\":[{\"name\":\"event_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}}],\"connect.name\":\"order_created.order_command.order_created_events.Value\"}");
   ...
   */
  public static order_created.order_command.order_created_events.Value.Builder newBuilder() {
    return new order_created.order_command.order_created_events.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static order_created.order_command.order_created_events.Value.Builder newBuilder(order_created.order_command.order_created_events.Value.Builder other) {
    if (other == null) {
      return new order_created.order_command.order_created_events.Value.Builder();
    } else {
      return new order_created.order_command.order_created_events.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static order_created.order_command.order_created_events.Value.Builder newBuilder(order_created.order_command.order_created_events.Value other) {
    if (other == null) {
      return new order_created.order_command.order_created_events.Value.Builder();
    } else {
      return new order_created.order_command.order_created_events.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(order_created.order_command.order_created_events.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(order_created.order_command.order_created_events.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.event_id)) {
        this.event_id = data().deepCopy(fields()[0].schema(), other.event_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder setEventId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder clearEventId() {
      event_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public order_created.order_command.order_created_events.Value.Builder clearCreatedAt() {
