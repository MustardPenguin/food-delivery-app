 ...
 */
package payment_created.payment.payment_created_events;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7997992309203455100L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"payment_created.payment.payment_created_events\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"event_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}}],\"connect.name\":\"payment_created.payment.payment_created_events.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.postgresql\",\"fields\":[{\"name\":\"version\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"connector\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":\"long\"},{\"name\":\"snapshot\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"true,last,false,incremental\"},\"connect.default\":\"false\",\"connect.name\":\"io.debezium.data.Enum\"},\"null\"],\"default\":\"false\"},{\"name\":\"db\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sequence\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"ts_us\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_ns\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"schema\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"table\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"txId\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"lsn\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"xmin\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.postgresql.Source\"}},{\"name\":\"transaction\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"block\",\"namespace\":\"event\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"total_order\",\"type\":\"long\"},{\"name\":\"data_collection_order\",\"type\":\"long\"}],\"connect.version\":1,\"connect.name\":\"event.block\"}],\"default\":null},{\"name\":\"op\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_us\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"ts_ns\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.version\":2,\"connect.name\":\"payment_created.payment.payment_created_events.Envelope\"}");
  ...
  private payment_created.payment.payment_created_events.Value before;
  private payment_created.payment.payment_created_events.Value after;
   ...
   */
  public Envelope(payment_created.payment.payment_created_events.Value before, payment_created.payment.payment_created_events.Value after, io.debezium.connector.postgresql.Source source, event.block transaction, java.lang.String op, java.lang.Long ts_ms, java.lang.Long ts_us, java.lang.Long ts_ns) {
    this.before = before;
    this.after = after;
    this.source = source;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (payment_created.payment.payment_created_events.Value)value$; break;
    case 1: after = (payment_created.payment.payment_created_events.Value)value$; break;
   ...
   */
  public payment_created.payment.payment_created_events.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(payment_created.payment.payment_created_events.Value value) {
    this.before = value;
  }
   ...
   */
  public payment_created.payment.payment_created_events.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(payment_created.payment.payment_created_events.Value value) {
    this.after = value;
  }
   ...
   */
  public static payment_created.payment.payment_created_events.Envelope.Builder newBuilder() {
    return new payment_created.payment.payment_created_events.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static payment_created.payment.payment_created_events.Envelope.Builder newBuilder(payment_created.payment.payment_created_events.Envelope.Builder other) {
    if (other == null) {
      return new payment_created.payment.payment_created_events.Envelope.Builder();
    } else {
      return new payment_created.payment.payment_created_events.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static payment_created.payment.payment_created_events.Envelope.Builder newBuilder(payment_created.payment.payment_created_events.Envelope other) {
    if (other == null) {
      return new payment_created.payment.payment_created_events.Envelope.Builder();
    } else {
      return new payment_created.payment.payment_created_events.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private payment_created.payment.payment_created_events.Value before;
    private payment_created.payment.payment_created_events.Value.Builder beforeBuilder;
    private payment_created.payment.payment_created_events.Value after;
    private payment_created.payment.payment_created_events.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(payment_created.payment.payment_created_events.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = payment_created.payment.payment_created_events.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = payment_created.payment.payment_created_events.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(payment_created.payment.payment_created_events.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setBefore(payment_created.payment.payment_created_events.Value value) {
     ...
     * @return This builder.
     */
    public payment_created.payment.payment_created_events.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(payment_created.payment.payment_created_events.Value.newBuilder(before));
        } else {
          setBeforeBuilder(payment_created.payment.payment_created_events.Value.newBuilder());
        }
      }
    ...
    public payment_created.payment.payment_created_events.Envelope.Builder setBeforeBuilder(payment_created.payment.payment_created_events.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setAfter(payment_created.payment.payment_created_events.Value value) {
     ...
     * @return This builder.
     */
    public payment_created.payment.payment_created_events.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(payment_created.payment.payment_created_events.Value.newBuilder(after));
        } else {
          setAfterBuilder(payment_created.payment.payment_created_events.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public payment_created.payment.payment_created_events.Envelope.Builder setAfterBuilder(payment_created.payment.payment_created_events.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public payment_created.payment.payment_created_events.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setTransaction(event.block value) {
    ...
    public payment_created.payment.payment_created_events.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setTsUs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearTsUs() {
      ts_us = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder setTsNs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_created.payment.payment_created_events.Envelope.Builder clearTsNs() {
      ts_ns = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (payment_created.payment.payment_created_events.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (payment_created.payment.payment_created_events.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new payment_created.payment.payment_created_events.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new payment_created.payment.payment_created_events.Value();
        }
